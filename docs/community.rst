...
Please join `Slack chat <https://fugue-project.slack.com/join/shared_invite/zt-jl0pcahu-KdlSOgi~fP50TZWmNxdWYQ#/shared-invite/email>`_
...
`slack <https://fugue-project.slack.com/join/shared_invite/zt-jl0pcahu-KdlSOgi~fP50TZWmNxdWYQ#/shared-invite/email>`_.
...
using `slack <https://fugue-project.slack.com/join/shared_invite/zt-jl0pcahu-KdlSOgi~fP50TZWmNxdWYQ#/shared-invite/email>`_, we will
