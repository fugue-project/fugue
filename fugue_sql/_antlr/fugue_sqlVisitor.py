...
class fugue_sqlVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by fugue_sqlParser#fugueEngineSpecificQueryTask.
    def visitFugueEngineSpecificQueryTask(self, ctx:fugue_sqlParser.FugueEngineSpecificQueryTaskContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by fugue_sqlParser#fugueHeadTask.
    def visitFugueHeadTask(self, ctx:fugue_sqlParser.FugueHeadTaskContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by fugue_sqlParser#fugueCheckpointYield.
    def visitFugueCheckpointYield(self, ctx:fugue_sqlParser.FugueCheckpointYieldContext):
        return self.visitChildren(ctx)
